...
export type Query = {
  ...
  predictParking: Scalars['String']['output'];
};
...
export type QueryPredictParkingArgs = {
...
export type PredictParkingQueryVariables = Exact<{
  datetime: Scalars['DateTime']['input'];
}>;


export type PredictParkingQuery = { __typename?: 'Query', predictParking: string };
...
export const PredictParkingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PredictParking"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"datetime"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"predictParking"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"datetime"},"value":{"kind":"Variable","name":{"kind":"Name","value":"datetime"}}}]}]}}]} as unknown as DocumentNode<PredictParkingQuery, PredictParkingQueryVariables>;